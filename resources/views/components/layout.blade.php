...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                <x-dropdown>
                    ...
                    @endadmin
                    <x-dropdown-item href="/register/{{auth()->user()->username}}/edit"
                        :active="request()->is('register/{{auth()->user()->username}}/edit')">Edit account
                    </x-dropdown-item>
                    <x-dropdown-item href="/user/favorites"
                         :active="request()->is('user/favorites')">Favorites</x-dropdown-item>
        ...
        <footer id="newsletter"
            ...
            <p class="text-sm mt-3 text-center">Promise to keep the inbox clean. No bugs.</p>
